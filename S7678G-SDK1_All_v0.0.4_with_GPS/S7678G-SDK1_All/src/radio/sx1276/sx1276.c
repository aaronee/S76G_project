...
__IO bool LoRaOscType = false;    // false for TCXO, true for Crystal, default is false(=TCXO).
static Gpio_t LoRa_TcxoOePin;
static Gpio_t LoRa_OscSelectPin;
#endif
...
//AcSiP(+), for setting TCXO oscillator
void SX1276SetOscillator( void )
{
#if defined( REGION_CN470 ) || defined( REGION_EU433 )
